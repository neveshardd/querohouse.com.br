...
async function seedHomeData() {
  try {
    ...
    // Criar propriedades para Brasília
    const properties = [
      // Propriedades em destaque (com muitas visualizações)
      {
      ...
      // Propriedades recentes (recém-cadastradas)
      {
      ...
      // Propriedades com melhor preço (até R$ 300.000)
      {
      ...
      // Mais propriedades para completar
      {
    ...
    // Criar mais usuários para estatísticas
