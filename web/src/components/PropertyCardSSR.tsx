...
/**
 * Versão SSR-safe do PropertyCard sem animações
 * Para uso em páginas que precisam de renderização no servidor
 */
export default function PropertyCardSSR({ property }: PropertyCardSSRProps) {
  return (
