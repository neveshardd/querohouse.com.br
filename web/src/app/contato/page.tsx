      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-xl mx-auto">
            Estamos aqui para ajudar você a encontrar o imóvel dos seus sonhos ou vender o seu imóvel
          </p>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="busca-imovel">Busca por Imóvel</option>
                    <option value="vender-imovel">Vender Imóvel</option>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contato@querohouse.com.br</p>
